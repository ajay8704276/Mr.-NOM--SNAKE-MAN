...
public class GameScreen extends Screen {
    ...
    //Initially  Assigned the game state in ready mode
    ...
    private void drawWorld(World world) {
        ...
        SnakePart head = snake.part.get(0);
        ...
        int len = snake.part.size();
        for(int i = 1; i < len; i++) {
            SnakePart part = snake.part.get(i);
            x = part.x * 32;
            y = part.y * 32;
